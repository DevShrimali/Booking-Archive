    ...
    <section className="py-20 bg-[#F8F8F8] border-b border-gray-200">
      <div className="container mx-auto px-4 md:px-8 max-w-[1440px]">
        <div className="text-center mb-16">
           <h2 className="text-3xl font-serif font-bold text-[#111827]">How It Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {steps.map((item, index) => (
              <div key={index} className="relative z-10 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-white border-2 border-gray-200 text-[#111827] font-bold font-serif text-lg flex items-center justify-center mb-6 shadow-sm group-hover:border-[#0055FF] transition-colors">
                  {item.step}
                </div>
